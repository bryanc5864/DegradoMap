...
\change{Lines 412--417 (new ``Dataset characteristics and limitations'' paragraph, \S4 Results, before any performance numbers); Limitation item~1 at line 732 (small dataset); Limitation item~2 at line 733 (E3 imbalance); Limitation item~6 at line 737 (no external validation).}
...
\change{Limitation item~5 at line 736 (``No structural validation''); BRD4 case study (\S4.5, lines 655--672) provides partial structural validation via lysine attention weight analysis on a known target.}
...
\begin{itemize}[topsep=2pt,itemsep=1pt]
  \item BRD4 (O60885) is predicted highly degradable with CRBN (score: 0.87). \change{Line 659.}
  \item Lysine attention weights identify \textbf{K374} (attention: 0.12, SASA: 94\,\AA$^2$) as the top residue---located in a disordered, solvent-exposed linker between bromodomains. \change{Lines 660--666.}
  \item \textbf{Literature validation}: mass spectrometry studies by Zengerle et al.\ (2015) confirm K374 as a major ubiquitination site following JQ1-based PROTAC treatment. \change{Lines 668--671.}
  \item We acknowledge this is a single successful case and that systematic validation across more targets would strengthen confidence. \change{Line 672.}
\end{itemize}

\change{New \S4.5 ``Case Study: BRD4 Degradability'' at lines 655--672.}
...
\begin{enumerate}[topsep=2pt,itemsep=1pt]
  ...
  \change{Lines 593--599 (``Six-seed extended validation'' paragraph); Figure~4 at line 605; Table~1 at lines 421--438 (both 3-seed and 6-seed rows).}
  ...
  \change{Abstract line 65 (``0.646$\pm$0.124 AUROC\ldots (best seed: 0.7449)''); Introduction line 132 (``3-seed mean of 0.646\ldots and 6-seed mean of 0.603''); Table~1 line 424 (``Best Seed'' as separate column); Results line 440--442 (``multi-seed averages as primary results\ldots best-seed performance should not be interpreted as typical expectation''); Conclusion line 749 (leads with average).}
  ...
  \change{Abstract line 65 (``CRBN$\to$VHL E3-unseen transfer''); Section heading line 608 (``E3 generalization is limited to major ligases''); Root cause analysis lines 612--620; Per-E3 Table~5 at line 625; Per-E3 Figure~5 at line 639; Conclusion line 749 (``CRBN$\to$VHL transfer (0.811 AUROC)'').}
\end{enumerate}
...
\midrule
Small dataset (C1) & \S4 L412--417 (dataset limitations paragraph); Limitations L732, L733, L737 \\
No structural validation (C2) & Limitation~5 L736; \S4.5 L655--672 (BRD4 partial validation) \\
No case study (C3) & New \S4.5 L655--672 (BRD4 with K374 literature validation) \\
Seed instability & \S4.3 L593--599 (6-seed validation); Table~1 L421--438; Figure~4 L605 \\
Best seed emphasis & Abstract L65; Introduction L132; Table~1 L424; \S4.2 L440--442; Conclusion L749 \\
E3 claims too broad & Abstract L65; \S4.3 L608--620; Table~5 L625; Figure~5 L639; Conclusion L749 \\
\bottomrule
\end{tabular}
\end{center}
