...
\paragraph{Protein language models and structure-based prediction.}
...
\paragraph{Validation-test mismatch.}
...
\paragraph{Dataset characteristics and limitations.}
...
\paragraph{E(3)-equivariance underperforms.}
...
\paragraph{ESM-2 requires careful integration.}
...
\paragraph{Six-seed extended validation.}
...
\paragraph{E3 generalization is limited to major ligases.}
...
\paragraph{Root cause analysis: why does VHL fail?}
...
\paragraph{Reconciling performance estimates.}
...
\paragraph{Honest performance assessment.}
