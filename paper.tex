...
\Description{Block diagram showing SUGNet architecture with four modules: SUG encoder with lysine-weighted pooling, E3 compatibility cross-attention, cellular context encoder, and gated fusion producing binary and continuous predictions.}
...
\Description{Grouped bar chart comparing AUROC across evaluation splits for SUGNet, SchNet, EGNN, Gradient Boosting, Random Forest, MLP, and Logistic Regression with error bars.}
\caption{AUROC comparison across evaluation splits for all models. Error bars show 95\% bootstrap CIs (SUGNet) or multi-seed standard deviation (GNN baselines). Dashed line indicates random performance (0.5). \ours{} achieves the best target-unseen performance; tree-based methods dominate only on random splits.}
...
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Seed} & \textbf{Test AUROC} & \textbf{Best Val AUROC} & \textbf{Early Stop Epoch} \\
\midrule
42  & \textbf{0.7449} & 0.562 & 8 \\
123 & 0.688 & 0.697 & 10 (no stop) \\
456 & 0.506 & 0.595 & 6 \\
\midrule
...
Code, pre-trained models, and reproducibility scripts are available at \url{https://github.com/anonymous/sugnet}.
...
\begin{itemize}
    ...
    \item \textbf{Code and pre-trained models}: \url{https://github.com/anonymous/sugnet}
\end{itemize}
